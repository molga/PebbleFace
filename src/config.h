...
#define LATITUDE    12.96
#define LONGITUDE 77.56
#define TIMEZONE +5.5
...
#define AdditionalTimezone_1 -5.5						// Timezone offest
#define AdditionalTimezone_2 -10.5 						// Timezone offest
static char AdditionalTimezone_1_Description[] = "UTC"; // Timezone name to display
static char AdditionalTimezone_2_Description[] = "EST"; // Timezone name to display
// ----- Additional time zones to display on the top right
